...
public class EditItemActivity extends AppCompatActivity{
    ...
    public void deleteItem(View view) {
        DeleteItemCommand itemToBeDeleted = new DeleteItemCommand(item_list, item, context);
        itemToBeDeleted.execute();

        if (!itemToBeDeleted.isExecuted())
            return;
    ...
    public void saveItem(View view) {
        ...
        updated_item.setDimensions(dimensions);
