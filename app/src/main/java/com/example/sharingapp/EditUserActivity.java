...
public class EditUserActivity extends AppCompatActivity {
    ...
    public void deleteUser(View view) {
        ...
        DeleteUserCommand userToBeDeleted = new DeleteUserCommand(user_list, user, context);
        userToBeDeleted.execute();

        if(!userToBeDeleted.isExecuted())
            return;
